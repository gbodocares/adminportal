...
db.collection("students").where("dept", "==", "web design")
    .get()
    .then((querySnapshot) => {
    var Users = [];
    ...
    querySnapshot.forEach((doc) => {
        ...
        console.log(typeof(Users))
            ...
            <tr>
                ...
                <td style="font-weight: bold; color: teal;">${data.attendance + data.test + data.softSkillAtt + data.softSkillProject + data.finalProject}</td><td>${data.total}</td>
            </tr>
